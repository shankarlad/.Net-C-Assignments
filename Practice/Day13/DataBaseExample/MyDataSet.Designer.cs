...
namespace DataBaseExample {
    ...
    public partial class MyDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_Table_Department;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_Table_Department = this.Relations["FK_Table_Department"];
        }
        ...
        private void InitClass() {
            ...
            fkc = new global::System.Data.ForeignKeyConstraint("FK_Table_Department", new global::System.Data.DataColumn[] {
            ...
            this.relationFK_Table_Department = new global::System.Data.DataRelation("FK_Table_Department", new global::System.Data.DataColumn[] {
                        this.tableDepartment.DeptNoColumn}, new global::System.Data.DataColumn[] {
                        this.tableEmployees.DeptNoColumn}, false);
            this.Relations.Add(this.relationFK_Table_Department);
        }
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(int EmpNo, string Name, decimal Basic, DepartmentRow parentDepartmentRowByFK_Table_Department) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        Basic,
                        null};
                if ((parentDepartmentRowByFK_Table_Department != null)) {
                    columnValuesArray[3] = parentDepartmentRowByFK_Table_Department[0];
                }
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public DepartmentRow DepartmentRow {
                get {
                    return ((DepartmentRow)(this.GetParentRow(this.Table.ParentRelations["FK_Table_Department"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_Table_Department"]);
                }
            }
        }
        ...
        public partial class DepartmentRow : global::System.Data.DataRow {
            ...
            public EmployeesRow[] GetEmployeesRows() {
                if ((this.Table.ChildRelations["FK_Table_Department"] == null)) {
                    return new EmployeesRow[0];
                }
                else {
                    return ((EmployeesRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Table_Department"])));
                }
            }
        }
...
namespace DataBaseExample.MyDataSetTableAdapters {
...
SELECT EmpNo, Name, Basic, DeptNo FROM Employees WHERE (EmpNo = @EmpNo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBaseExample.Properties.Settings.Default.JKDec20ConnectionString;
        }
    ...
    public partial class DepartmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Department] SET [DeptNo] = @DeptNo, [DeptName] = @DeptName WHERE ((" +
                "[DeptNo] = @Original_DeptNo) AND ([DeptName] = @Original_DeptName));\r\nSELECT Dep" +
                "tNo, DeptName FROM Department WHERE (DeptNo = @DeptNo)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@DeptNo", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "DeptNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
